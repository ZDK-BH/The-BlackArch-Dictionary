...
**Category:** `automation`  
**Version in source list:** `24.7933022`  
**Package name:** `autonessus`
...
```bash
sudo pacman -S --needed autonessus
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql autonessus | grep '/bin/'
```
...
autonessus -i targets.txt -o results.txt
```
