...
**Category:** `automation`  
**Version in source list:** `338.7487348`  
**Package name:** `bashfuscator`
...
```bash
sudo pacman -S --needed bashfuscator
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql bashfuscator | grep '/bin/'
```
...
bashfuscator -i targets.txt -o results.txt
```
