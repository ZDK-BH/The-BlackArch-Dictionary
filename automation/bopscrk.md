...
**Category:** `automation`  
**Version in source list:** `v2.4.7.r2.g7eede16`  
**Package name:** `bopscrk`
...
```bash
sudo pacman -S --needed bopscrk
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql bopscrk | grep '/bin/'
```
...
bopscrk -i targets.txt -o results.txt
```
