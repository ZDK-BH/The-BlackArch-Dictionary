...
**Category:** `automation`  
**Version in source list:** `36.f0aad23`  
**Package name:** `commonspeak`
...
```bash
sudo pacman -S --needed commonspeak
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql commonspeak | grep '/bin/'
```
...
commonspeak -i targets.txt -o results.txt
```
