...
**Category:** `automation`  
**Version in source list:** `60.d7bcbfd`  
**Package name:** `deathstar`
...
```bash
sudo pacman -S --needed deathstar
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql deathstar | grep '/bin/'
```
...
deathstar -i targets.txt -o results.txt
```
