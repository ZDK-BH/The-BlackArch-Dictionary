...
**Category:** `automation`  
**Version in source list:** `1.0.r13.gdd87daf`  
**Package name:** `dorkscout`
...
```bash
sudo pacman -S --needed dorkscout
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql dorkscout | grep '/bin/'
```
...
dorkscout -i targets.txt -o results.txt
```
