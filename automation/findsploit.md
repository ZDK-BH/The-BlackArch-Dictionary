...
**Category:** `automation`  
**Version in source list:** `87.3e61d8d`  
**Package name:** `findsploit`
...
```bash
sudo pacman -S --needed findsploit
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql findsploit | grep '/bin/'
```
...
findsploit -i targets.txt -o results.txt
```
