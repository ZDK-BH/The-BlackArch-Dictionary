...
**Category:** `automation`  
**Version in source list:** `45.f20e7f8`  
**Package name:** `invoke-obfuscation`
...
```bash
sudo pacman -S --needed invoke-obfuscation
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql invoke-obfuscation | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
invoke-obfuscation --help
invoke-obfuscation -h
man invoke-obfuscation
```
...
invoke-obfuscation -i targets.txt -o results.txt
```
