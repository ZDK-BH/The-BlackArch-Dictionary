...
**Category:** `automation`  
**Version in source list:** `26.a170abc`  
**Package name:** `masscan-automation`
...
```bash
sudo pacman -S --needed masscan-automation
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql masscan-automation | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
masscan-automation --help
masscan-automation -h
man masscan-automation
```
...
masscan-automation -i targets.txt -o results.txt
```
