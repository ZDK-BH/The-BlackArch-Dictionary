...
**Category:** `automation`  
**Version in source list:** `v2.0.0.r1.g8223d8e`  
**Package name:** `mentalist`
...
```bash
sudo pacman -S --needed mentalist
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql mentalist | grep '/bin/'
```
...
mentalist -i targets.txt -o results.txt
```
