...
**Category:** `automation`  
**Version in source list:** `0.4.0.r210.gcbed0c4`  
**Package name:** `nettacker`
...
```bash
sudo pacman -S --needed nettacker
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql nettacker | grep '/bin/'
```
...
nettacker -i targets.txt -o results.txt
```
