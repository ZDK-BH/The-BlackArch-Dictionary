...
**Category:** `automation`  
**Version in source list:** `37.2c5ce07`  
**Package name:** `pureblood`
...
```bash
sudo pacman -S --needed pureblood
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql pureblood | grep '/bin/'
```
...
pureblood -i targets.txt -o results.txt
```
