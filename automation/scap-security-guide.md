...
```bash
sudo pacman -S --needed scap-security-guide
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql scap-security-guide | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
scap-security-guide --help
scap-security-guide -h
...
scap-security-guide -i targets.txt -o results.txt
```
