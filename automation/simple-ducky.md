...
**Category:** `automation`  
**Version in source list:** `20.f15079e`  
**Package name:** `simple-ducky`
...
```bash
sudo pacman -S --needed simple-ducky
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql simple-ducky | grep '/bin/'
```
...
simple-ducky -i targets.txt -o results.txt
```
