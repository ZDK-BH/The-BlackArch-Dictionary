...
**Category:** `automation`  
**Version in source list:** `87.c010a48`  
**Package name:** `valhalla-api`
...
```bash
sudo pacman -S --needed valhalla-api
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql valhalla-api | grep '/bin/'
```
...
valhalla-api -i targets.txt -o results.txt
```
