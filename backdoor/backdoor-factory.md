...
**Category:** `backdoor`  
**Version in source list:** `210.0c53045`  
**Package name:** `backdoor-factory`
...
```bash
sudo pacman -S --needed backdoor-factory
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql backdoor-factory | grep '/bin/'
```
