...
**Category:** `backdoor`  
**Version in source list:** `7.c7416b7`  
**Package name:** `dragon-backdoor`
...
```bash
sudo pacman -S --needed dragon-backdoor
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql dragon-backdoor | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
dragon-backdoor --help
dragon-backdoor -h
man dragon-backdoor
```
