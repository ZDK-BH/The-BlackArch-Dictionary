...
**Category:** `backdoor`  
**Version in source list:** `217.172027b`  
**Package name:** `unicorn-powershell`
...
```bash
sudo pacman -S --needed unicorn-powershell
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql unicorn-powershell | grep '/bin/'
```
...
unicorn-powershell -h
man unicorn-powershell
```
