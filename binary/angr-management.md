...
**Category:** `binary`  
**Version in source list:** `9.2.179`  
**Package name:** `angr-management`
...
```bash
sudo pacman -S --needed angr-management
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql angr-management | grep '/bin/'
```
