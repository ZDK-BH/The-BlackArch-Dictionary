...
**Category:** `binary`  
**Version in source list:** `222.2607a3a`  
**Package name:** `hercules-payload`
...
```bash
sudo pacman -S --needed hercules-payload
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql hercules-payload | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
hercules-payload --help
hercules-payload -h
man hercules-payload
```
