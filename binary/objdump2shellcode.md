...
**Category:** `binary`  
**Version in source list:** `28.c2d6120`  
**Package name:** `objdump2shellcode`
...
```bash
sudo pacman -S --needed objdump2shellcode
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql objdump2shellcode | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
objdump2shellcode --help
objdump2shellcode -h
man objdump2shellcode
```
