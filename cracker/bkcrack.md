...
**Category:** `cracker`  
**Version in source list:** `v1.8.1.r45.g95fbe95`  
**Package name:** `bkcrack`
...
```bash
sudo pacman -S --needed bkcrack
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql bkcrack | grep '/bin/'
```
...
bkcrack ./sample_hashes.txt ./wordlist.txt
```
