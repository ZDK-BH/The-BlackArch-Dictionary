...
**Category:** `cracker`  
**Version in source list:** `0.8.1`  
**Package name:** `bob-the-butcher`
...
```bash
sudo pacman -S --needed bob-the-butcher
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql bob-the-butcher | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
bob-the-butcher --help
bob-the-butcher -h
man bob-the-butcher
```
...
bob-the-butcher ./sample_hashes.txt ./wordlist.txt
```
