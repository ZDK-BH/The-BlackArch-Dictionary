...
**Category:** `cracker`  
**Version in source list:** `52.78d1d8e`  
**Package name:** `brute-force`
...
```bash
sudo pacman -S --needed brute-force
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql brute-force | grep '/bin/'
```
...
brute-force ./sample_hashes.txt ./wordlist.txt
```
