...
**Category:** `cracker`  
**Version in source list:** `43.648d7d7`  
...
```bash
sudo pacman -S --needed bruteforce-wallet
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql bruteforce-wallet | grep '/bin/'
```
...
bruteforce-wallet ./sample_hashes.txt ./wordlist.txt
```
