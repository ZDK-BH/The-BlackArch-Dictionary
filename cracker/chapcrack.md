...
**Category:** `cracker`  
**Version in source list:** `17.ae2827f`  
**Package name:** `chapcrack`
...
```bash
sudo pacman -S --needed chapcrack
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql chapcrack | grep '/bin/'
```
...
chapcrack ./sample_hashes.txt ./wordlist.txt
```
