...
**Category:** `cracker`  
**Version in source list:** `14.f8a3f12`  
**Package name:** `cintruder`
...
```bash
sudo pacman -S --needed cintruder
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql cintruder | grep '/bin/'
```
...
cintruder ./sample_hashes.txt ./wordlist.txt
```
