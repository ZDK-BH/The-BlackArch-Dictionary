...
**Package name:** `cisco-auditing-tool`
...
```bash
sudo pacman -S --needed cisco-auditing-tool
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql cisco-auditing-tool | grep '/bin/'
```
...
cisco-auditing-tool -h
man cisco-auditing-tool
```
...
cisco-auditing-tool ./sample_hashes.txt ./wordlist.txt
```
