...
**Category:** `cracker`  
**Version in source list:** `2.c4b228c`  
**Package name:** `cisco5crack`
...
```bash
sudo pacman -S --needed cisco5crack
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql cisco5crack | grep '/bin/'
```
...
cisco5crack ./sample_hashes.txt ./wordlist.txt
```
