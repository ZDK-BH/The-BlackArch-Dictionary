...
**Category:** `cracker`  
**Version in source list:** `0.2.10.11.c7dedb1`  
**Package name:** `crackpkcs12`
...
```bash
sudo pacman -S --needed crackpkcs12
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql crackpkcs12 | grep '/bin/'
```
...
crackpkcs12 ./sample_hashes.txt ./wordlist.txt
```
