...
**Category:** `cracker`  
**Version in source list:** `206.0a79f34`  
**Package name:** `credmaster`
...
```bash
sudo pacman -S --needed credmaster
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql credmaster | grep '/bin/'
```
...
credmaster ./sample_hashes.txt ./wordlist.txt
```
