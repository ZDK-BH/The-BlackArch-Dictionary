...
**Category:** `cracker`  
**Version in source list:** `beta002`  
**Package name:** `dpeparser`
...
```bash
sudo pacman -S --needed dpeparser
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql dpeparser | grep '/bin/'
```
...
dpeparser ./sample_hashes.txt ./wordlist.txt
```
