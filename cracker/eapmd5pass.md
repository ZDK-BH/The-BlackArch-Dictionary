...
**Category:** `cracker`  
**Version in source list:** `3.3d5551f`  
**Package name:** `eapmd5pass`
...
```bash
sudo pacman -S --needed eapmd5pass
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql eapmd5pass | grep '/bin/'
```
...
eapmd5pass ./sample_hashes.txt ./wordlist.txt
```
