...
**Category:** `cracker`  
**Version in source list:** `7.ece355b`  
**Package name:** `facebrute`
...
```bash
sudo pacman -S --needed facebrute
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql facebrute | grep '/bin/'
```
...
facebrute ./sample_hashes.txt ./wordlist.txt
```
