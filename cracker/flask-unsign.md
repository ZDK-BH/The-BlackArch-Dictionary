...
**Category:** `cracker`  
**Version in source list:** `v1.2.1.r0.g6e6e91d`  
**Package name:** `flask-unsign`
...
```bash
sudo pacman -S --needed flask-unsign
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql flask-unsign | grep '/bin/'
```
...
flask-unsign ./sample_hashes.txt ./wordlist.txt
```
