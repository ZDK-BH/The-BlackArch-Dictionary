...
**Category:** `cracker`  
**Version in source list:** `15.1f64f19`  
**Package name:** `icloudbrutter`
...
```bash
sudo pacman -S --needed icloudbrutter
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql icloudbrutter | grep '/bin/'
```
...
icloudbrutter ./sample_hashes.txt ./wordlist.txt
```
