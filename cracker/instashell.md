...
**Category:** `cracker`  
**Version in source list:** `44.8f867bd`  
**Package name:** `instashell`
...
```bash
sudo pacman -S --needed instashell
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql instashell | grep '/bin/'
```
...
instashell ./sample_hashes.txt ./wordlist.txt
```
