...
**Category:** `cracker`  
**Version in source list:** `160.28d8d1b`  
**Package name:** `o365spray`
...
```bash
sudo pacman -S --needed o365spray
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql o365spray | grep '/bin/'
```
...
o365spray ./sample_hashes.txt ./wordlist.txt
```
