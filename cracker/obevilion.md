...
**Category:** `cracker`  
**Version in source list:** `409.29fbe9d`  
**Package name:** `obevilion`
...
```bash
sudo pacman -S --needed obevilion
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql obevilion | grep '/bin/'
```
...
obevilion ./sample_hashes.txt ./wordlist.txt
```
