...
**Category:** `cracker`  
**Version in source list:** `1.1.0.r4.g964e87c`  
**Package name:** `patator`
...
```bash
sudo pacman -S --needed patator
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql patator | grep '/bin/'
```
...
patator ./sample_hashes.txt ./wordlist.txt
```
