...
**Category:** `cracker`  
**Version in source list:** `9.a741c93`  
**Package name:** `pemcracker`
...
```bash
sudo pacman -S --needed pemcracker
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql pemcracker | grep '/bin/'
```
...
pemcracker ./sample_hashes.txt ./wordlist.txt
```
