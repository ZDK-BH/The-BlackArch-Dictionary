...
**Category:** `cracker`  
**Version in source list:** `1.2.2c`  
**Package name:** `phrasendrescher`
...
```bash
sudo pacman -S --needed phrasendrescher
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql phrasendrescher | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
phrasendrescher --help
phrasendrescher -h
man phrasendrescher
```
...
phrasendrescher ./sample_hashes.txt ./wordlist.txt
```
