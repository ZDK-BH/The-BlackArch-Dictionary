...
**Category:** `cracker`  
**Version in source list:** `87.ceb0cd9`  
**Package name:** `pybozocrack`
...
```bash
sudo pacman -S --needed pybozocrack
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql pybozocrack | grep '/bin/'
```
...
pybozocrack ./sample_hashes.txt ./wordlist.txt
```
