...
**Category:** `cracker`  
**Version in source list:** `2.2ed1bac`  
**Package name:** `samydeluxe`
...
```bash
sudo pacman -S --needed samydeluxe
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql samydeluxe | grep '/bin/'
```
...
samydeluxe ./sample_hashes.txt ./wordlist.txt
```
