...
**Category:** `cracker`  
**Version in source list:** `v2.0.2.r3.g131f8c6`  
**Package name:** `spraycharles`
...
```bash
sudo pacman -S --needed spraycharles
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql spraycharles | grep '/bin/'
```
...
spraycharles ./sample_hashes.txt ./wordlist.txt
```
