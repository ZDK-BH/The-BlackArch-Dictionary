...
**Category:** `cracker`  
**Version in source list:** `83.24b715e`  
**Package name:** `timeverter`
...
```bash
sudo pacman -S --needed timeverter
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql timeverter | grep '/bin/'
```
...
timeverter ./sample_hashes.txt ./wordlist.txt
```
