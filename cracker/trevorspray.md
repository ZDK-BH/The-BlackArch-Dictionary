...
**Category:** `cracker`  
**Version in source list:** `2.3.0`  
**Package name:** `trevorspray`
...
```bash
sudo pacman -S --needed trevorspray
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql trevorspray | grep '/bin/'
```
...
trevorspray ./sample_hashes.txt ./wordlist.txt
```
