...
**Category:** `cracker`  
**Version in source list:** `21.47a415c`  
**Package name:** `tweetshell`
...
```bash
sudo pacman -S --needed tweetshell
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql tweetshell | grep '/bin/'
```
...
tweetshell ./sample_hashes.txt ./wordlist.txt
```
