...
**Category:** `cracker`  
**Version in source list:** `3.e7d8145`  
**Package name:** `wpbrute-rpc`
...
```bash
sudo pacman -S --needed wpbrute-rpc
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql wpbrute-rpc | grep '/bin/'
```
...
wpbrute-rpc ./sample_hashes.txt ./wordlist.txt
```
