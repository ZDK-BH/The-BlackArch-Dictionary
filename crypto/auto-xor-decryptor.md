...
**Category:** `crypto`  
**Version in source list:** `7.2eb176d`  
**Package name:** `auto-xor-decryptor`
...
```bash
sudo pacman -S --needed auto-xor-decryptor
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql auto-xor-decryptor | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
auto-xor-decryptor --help
auto-xor-decryptor -h
man auto-xor-decryptor
```
