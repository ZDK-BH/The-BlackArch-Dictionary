...
**Category:** `decompiler`  
**Version in source list:** `v7.2.rc.r11.g21d4939`  
**Package name:** `avaloniailspy`
...
```bash
sudo pacman -S --needed avaloniailspy
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql avaloniailspy | grep '/bin/'
```
