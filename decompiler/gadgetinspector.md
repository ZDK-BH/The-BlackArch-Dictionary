...
**Category:** `decompiler`  
**Version in source list:** `6.ac7832d`  
**Package name:** `gadgetinspector`
...
```bash
sudo pacman -S --needed gadgetinspector
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql gadgetinspector | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
gadgetinspector --help
gadgetinspector -h
man gadgetinspector
```
