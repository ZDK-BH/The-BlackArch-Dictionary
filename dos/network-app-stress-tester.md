...
**Category:** `dos`  
**Version in source list:** `19.df75391`  
**Package name:** `network-app-stress-tester`
...
```bash
sudo pacman -S --needed network-app-stress-tester
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql network-app-stress-tester | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
network-app-stress-tester --help
network-app-stress-tester -h
man network-app-stress-tester
```
