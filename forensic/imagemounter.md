...
**Category:** `forensic`  
**Version in source list:** `413.383b30b`  
**Package name:** `imagemounter`
...
```bash
sudo pacman -S --needed imagemounter
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql imagemounter | grep '/bin/'
```
...
imagemounter ./evidence-copy.img
```
