...
**Category:** `forensic`  
**Version in source list:** `60.c7a0ae7e`  
**Package name:** `log-file-parser`
...
```bash
sudo pacman -S --needed log-file-parser
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql log-file-parser | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
log-file-parser --help
log-file-parser -h
man log-file-parser
```
...
log-file-parser ./evidence-copy.img
```
