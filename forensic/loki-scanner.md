...
**Category:** `forensic`  
**Version in source list:** `1258.7688421`  
**Package name:** `loki-scanner`
...
```bash
sudo pacman -S --needed loki-scanner
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql loki-scanner | grep '/bin/'
```
...
loki-scanner ./evidence-copy.img
```
