...
**Category:** `forensic`  
**Version in source list:** `6.f2b23d72`  
**Package name:** `ntfs-file-extractor`
...
```bash
sudo pacman -S --needed ntfs-file-extractor
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql ntfs-file-extractor | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
ntfs-file-extractor --help
ntfs-file-extractor -h
man ntfs-file-extractor
```
...
ntfs-file-extractor ./evidence-copy.img
```
