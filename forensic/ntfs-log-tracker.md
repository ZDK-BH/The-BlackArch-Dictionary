...
```bash
sudo pacman -S --needed ntfs-log-tracker
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql ntfs-log-tracker | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
ntfs-log-tracker --help
ntfs-log-tracker -h
man ntfs-log-tracker
```
...
ntfs-log-tracker ./evidence-copy.img
```
