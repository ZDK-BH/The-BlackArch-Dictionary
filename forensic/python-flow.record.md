...
**Category:** `forensic`  
**Version in source list:** `3.21.r16.ge6b58fd`  
**Package name:** `python-flow.record`
...
```bash
sudo pacman -S --needed python-flow.record
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql python-flow.record | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
python-flow.record --help
python-flow.record -h
man python-flow.record
```
...
python-flow.record ./evidence-copy.img
```
