...
**Category:** `forensic`  
**Version in source list:** `2.5e22518`  
**Package name:** `recentfilecache-parser`
...
```bash
sudo pacman -S --needed recentfilecache-parser
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql recentfilecache-parser | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
recentfilecache-parser --help
recentfilecache-parser -h
man recentfilecache-parser
```
...
recentfilecache-parser ./evidence-copy.img
```
