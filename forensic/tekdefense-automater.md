...
**Category:** `forensic`  
**Version in source list:** `88.42548cf`  
**Package name:** `tekdefense-automater`
...
```bash
sudo pacman -S --needed tekdefense-automater
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql tekdefense-automater | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
tekdefense-automater --help
tekdefense-automater -h
man tekdefense-automater
```
...
tekdefense-automater ./evidence-copy.img
```
