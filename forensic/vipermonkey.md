...
**Category:** `forensic`  
**Version in source list:** `1160.511ecd5`  
**Package name:** `vipermonkey`
...
```bash
sudo pacman -S --needed vipermonkey
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql vipermonkey | grep '/bin/'
```
