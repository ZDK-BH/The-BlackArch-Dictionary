...
**Category:** `forensic`  
**Version in source list:** `92.d9fc072`  
**Package name:** `volatility-extra`
...
```bash
sudo pacman -S --needed volatility-extra
```
...
```bash
volatility-extra --help
volatility-extra -h
man volatility-extra
```
...
volatility-extra ./evidence-copy.img
```
