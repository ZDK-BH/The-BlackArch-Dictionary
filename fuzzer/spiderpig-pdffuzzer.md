...
**Package name:** `spiderpig-pdffuzzer`
...
```bash
sudo pacman -S --needed spiderpig-pdffuzzer
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql spiderpig-pdffuzzer | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
spiderpig-pdffuzzer --help
spiderpig-pdffuzzer -h
man spiderpig-pdffuzzer
```
...
spiderpig-pdffuzzer ./test-program
```
