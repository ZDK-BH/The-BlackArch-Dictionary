...
**Package name:** `tcpcontrol-fuzzer`
...
```bash
sudo pacman -S --needed tcpcontrol-fuzzer
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql tcpcontrol-fuzzer | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
tcpcontrol-fuzzer --help
tcpcontrol-fuzzer -h
man tcpcontrol-fuzzer
```
...
tcpcontrol-fuzzer ./test-program
```
