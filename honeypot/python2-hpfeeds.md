...
**Category:** `honeypot`  
**Version in source list:** `414.34bf4d4`  
**Package name:** `python2-hpfeeds`
...
```bash
sudo pacman -S --needed python2-hpfeeds
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql python2-hpfeeds | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
python2-hpfeeds --help
python2-hpfeeds -h
man python2-hpfeeds
```
