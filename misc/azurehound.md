...
**Category:** `misc`  
**Version in source list:** `2.12.2.rc1.r0.g195e96f`  
**Package name:** `azurehound`
...
```bash
sudo pacman -S --needed azurehound
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql azurehound | grep '/bin/'
```
...
```bash
pacman -Ql azurehound | sed -n "1,120p"
```
