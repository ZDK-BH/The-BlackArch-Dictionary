...
**Category:** `misc`  
**Version in source list:** `v5.0.0.r36.g0343d0e`  
**Package name:** `ctf-party`
...
```bash
sudo pacman -S --needed ctf-party
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql ctf-party | grep '/bin/'
```
...
```bash
pacman -Ql ctf-party | sed -n "1,120p"
```
