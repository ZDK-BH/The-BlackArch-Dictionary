...
**Category:** `misc`  
**Version in source list:** `1.2192bf7`  
**Package name:** `ffuf-scripts`
...
```bash
sudo pacman -S --needed ffuf-scripts
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql ffuf-scripts | grep '/bin/'
```
...
```bash
pacman -Ql ffuf-scripts | sed -n "1,120p"
```
