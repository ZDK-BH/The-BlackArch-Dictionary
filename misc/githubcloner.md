...
**Category:** `misc`  
**Version in source list:** `36.20203e7`  
**Package name:** `githubcloner`
...
```bash
sudo pacman -S --needed githubcloner
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql githubcloner | grep '/bin/'
```
...
```bash
pacman -Ql githubcloner | sed -n "1,120p"
```
