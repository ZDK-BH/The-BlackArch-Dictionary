...
**Category:** `misc`  
**Version in source list:** `69.cc50e6e`  
**Package name:** `gtfoblookup`
...
```bash
sudo pacman -S --needed gtfoblookup
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql gtfoblookup | grep '/bin/'
```
...
```bash
pacman -Ql gtfoblookup | sed -n "1,120p"
```
