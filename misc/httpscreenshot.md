...
**Category:** `misc`  
**Version in source list:** `70.f081c69`  
**Package name:** `httpscreenshot`
...
```bash
sudo pacman -S --needed httpscreenshot
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql httpscreenshot | grep '/bin/'
```
...
```bash
pacman -Ql httpscreenshot | sed -n "1,120p"
```
