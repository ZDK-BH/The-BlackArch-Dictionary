...
**Category:** `misc`  
**Version in source list:** `20.afca9c5`  
**Package name:** `hurl-encoder`
...
```bash
sudo pacman -S --needed hurl-encoder
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql hurl-encoder | grep '/bin/'
```
...
```bash
pacman -Ql hurl-encoder | sed -n "1,120p"
```
