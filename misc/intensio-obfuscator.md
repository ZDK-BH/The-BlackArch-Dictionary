...
**Category:** `misc`  
**Version in source list:** `280.f66a22b`  
**Package name:** `intensio-obfuscator`
...
```bash
sudo pacman -S --needed intensio-obfuscator
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql intensio-obfuscator | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
intensio-obfuscator --help
intensio-obfuscator -h
man intensio-obfuscator
```
...
```bash
pacman -Ql intensio-obfuscator | sed -n "1,120p"
```
