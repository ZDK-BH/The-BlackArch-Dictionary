...
**Category:** `misc`  
**Version in source list:** `27.f005262`  
**Package name:** `ipobfuscator`
...
```bash
sudo pacman -S --needed ipobfuscator
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql ipobfuscator | grep '/bin/'
```
...
```bash
pacman -Ql ipobfuscator | sed -n "1,120p"
```
