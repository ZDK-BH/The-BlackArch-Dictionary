...
**Category:** `misc`  
**Version in source list:** `v0.0.1.r22.gb536ea0`  
**Package name:** `openrisk`
...
```bash
sudo pacman -S --needed openrisk
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql openrisk | grep '/bin/'
```
...
```bash
pacman -Ql openrisk | sed -n "1,120p"
```
