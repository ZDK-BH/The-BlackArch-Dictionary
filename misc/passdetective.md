...
**Category:** `misc`  
**Version in source list:** `1.0.6.r4.g458f12e`  
**Package name:** `passdetective`
...
```bash
sudo pacman -S --needed passdetective
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql passdetective | grep '/bin/'
```
...
```bash
pacman -Ql passdetective | sed -n "1,120p"
```
