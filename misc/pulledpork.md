...
**Category:** `misc`  
**Version in source list:** `397.5ccf5c5`  
**Package name:** `pulledpork`
...
```bash
sudo pacman -S --needed pulledpork
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql pulledpork | grep '/bin/'
```
...
```bash
pacman -Ql pulledpork | sed -n "1,120p"
```
