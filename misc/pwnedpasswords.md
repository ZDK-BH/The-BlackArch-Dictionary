...
**Category:** `misc`  
**Version in source list:** `3.0.0.r7.ge33d4bb`  
**Package name:** `pwnedpasswords`
...
```bash
sudo pacman -S --needed pwnedpasswords
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql pwnedpasswords | grep '/bin/'
```
...
```bash
pacman -Ql pwnedpasswords | sed -n "1,120p"
```
