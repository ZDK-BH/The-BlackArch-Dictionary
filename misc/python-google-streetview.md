...
**Package name:** `python-google-streetview`
...
```bash
sudo pacman -S --needed python-google-streetview
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql python-google-streetview | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
python-google-streetview --help
python-google-streetview -h
man python-google-streetview
```
...
```bash
pacman -Ql python-google-streetview | sed -n "1,120p"
```
