...
**Category:** `misc`  
**Version in source list:** `1.2.9`  
**Package name:** `python2-google-streetview`
...
```bash
sudo pacman -S --needed python2-google-streetview
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql python2-google-streetview | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
python2-google-streetview --help
python2-google-streetview -h
man python2-google-streetview
```
...
```bash
pacman -Ql python2-google-streetview | sed -n "1,120p"
```
