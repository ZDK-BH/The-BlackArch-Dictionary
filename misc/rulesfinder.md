...
**Category:** `misc`  
**Version in source list:** `42.cf8255b`  
**Package name:** `rulesfinder`
...
```bash
sudo pacman -S --needed rulesfinder
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql rulesfinder | grep '/bin/'
```
...
```bash
pacman -Ql rulesfinder | sed -n "1,120p"
```
