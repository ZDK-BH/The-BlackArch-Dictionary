...
**Category:** `misc`  
**Version in source list:** `0.7.0.r0.gf12f8d6`  
**Package name:** `shadowfinder`
...
```bash
sudo pacman -S --needed shadowfinder
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql shadowfinder | grep '/bin/'
```
...
```bash
pacman -Ql shadowfinder | sed -n "1,120p"
```
