...
**Category:** `misc`  
**Version in source list:** `1.19.1.r1.gf82b192a6`  
**Package name:** `verinice`
...
```bash
sudo pacman -S --needed verinice
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql verinice | grep '/bin/'
```
...
```bash
pacman -Ql verinice | sed -n "1,120p"
```
