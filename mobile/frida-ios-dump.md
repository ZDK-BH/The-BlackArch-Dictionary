...
**Category:** `mobile`  
**Version in source list:** `53.56e99b2`  
**Package name:** `frida-ios-dump`
...
```bash
sudo pacman -S --needed frida-ios-dump
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql frida-ios-dump | grep '/bin/'
```
