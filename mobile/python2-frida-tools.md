...
**Category:** `mobile`  
**Version in source list:** `11.0.0`  
**Package name:** `python2-frida-tools`
...
```bash
sudo pacman -S --needed python2-frida-tools
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql python2-frida-tools | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
python2-frida-tools --help
python2-frida-tools -h
man python2-frida-tools
```
