...
**Category:** `networking`  
**Version in source list:** `33.c55b7ce`  
**Package name:** `bypass-firewall-dns-history`
...
```bash
sudo pacman -S --needed bypass-firewall-dns-history
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql bypass-firewall-dns-history | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
bypass-firewall-dns-history --help
bypass-firewall-dns-history -h
man bypass-firewall-dns-history
```
