...
**Category:** `networking`  
**Version in source list:** `380.455f5ef`  
**Package name:** `libparistraceroute`
...
```bash
sudo pacman -S --needed libparistraceroute
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql libparistraceroute | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
libparistraceroute --help
libparistraceroute -h
man libparistraceroute
```
