...
**Package name:** `python2-cymruwhois`
...
```bash
sudo pacman -S --needed python2-cymruwhois
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql python2-cymruwhois | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
python2-cymruwhois --help
python2-cymruwhois -h
man python2-cymruwhois
```
