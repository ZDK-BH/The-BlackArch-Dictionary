...
**Category:** `proxy`  
**Version in source list:** `51.1ced3be`  
**Package name:** `elite-proxy-finder`
...
```bash
sudo pacman -S --needed elite-proxy-finder
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql elite-proxy-finder | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
elite-proxy-finder --help
elite-proxy-finder -h
man elite-proxy-finder
```
