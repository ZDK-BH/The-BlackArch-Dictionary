...
**Package name:** `forkingportscanner`
...
```bash
sudo pacman -S --needed forkingportscanner
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql forkingportscanner | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
forkingportscanner --help
forkingportscanner -h
man forkingportscanner
```
