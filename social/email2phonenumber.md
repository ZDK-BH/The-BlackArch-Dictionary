...
**Category:** `social`  
**Version in source list:** `29.9df9dbe`  
**Package name:** `email2phonenumber`
...
```bash
sudo pacman -S --needed email2phonenumber
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql email2phonenumber | grep '/bin/'
```
