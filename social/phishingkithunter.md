...
**Category:** `social`  
**Version in source list:** `20.ac9bd1e`  
**Package name:** `phishingkithunter`
...
```bash
sudo pacman -S --needed phishingkithunter
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql phishingkithunter | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
phishingkithunter --help
phishingkithunter -h
man phishingkithunter
```
