...
**Category:** `social`  
**Version in source list:** `54.7075f0c`  
**Package name:** `simpleemailspoofer`
...
```bash
sudo pacman -S --needed simpleemailspoofer
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql simpleemailspoofer | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
simpleemailspoofer --help
simpleemailspoofer -h
man simpleemailspoofer
```
