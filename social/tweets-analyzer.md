...
**Category:** `social`  
**Version in source list:** `55.8d6bd3c`  
**Package name:** `tweets-analyzer`
...
```bash
sudo pacman -S --needed tweets-analyzer
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql tweets-analyzer | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
tweets-analyzer --help
tweets-analyzer -h
man tweets-analyzer
```
