...
**Category:** `social`  
**Version in source list:** `236.5661bdc`  
**Package name:** `ultimate-facebook-scraper`
...
```bash
sudo pacman -S --needed ultimate-facebook-scraper
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql ultimate-facebook-scraper | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
ultimate-facebook-scraper --help
ultimate-facebook-scraper -h
man ultimate-facebook-scraper
```
