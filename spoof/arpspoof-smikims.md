...
**Category:** `spoof`  
**Version in source list:** `31.ef5f0b1`  
**Package name:** `arpspoof-smikims`
...
```bash
sudo pacman -S --needed arpspoof-smikims
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql arpspoof-smikims | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
arpspoof-smikims --help
arpspoof-smikims -h
man arpspoof-smikims
```
