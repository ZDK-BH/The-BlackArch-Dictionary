...
**Package name:** `erase-registrations`
...
```bash
sudo pacman -S --needed erase-registrations
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql erase-registrations | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
erase-registrations --help
erase-registrations -h
man erase-registrations
```
