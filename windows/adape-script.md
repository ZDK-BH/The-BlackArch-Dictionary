...
**Category:** `windows`  
**Version in source list:** `43.4d0b9ff`  
**Package name:** `adape-script`
...
```bash
sudo pacman -S --needed adape-script
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql adape-script | grep '/bin/'
```
...
```bash
# Package contents:
pacman -Ql adape-script | sed -n "1,80p"
```
