...
**Category:** `windows`  
**Version in source list:** `0.0.0.5`  
**Package name:** `analyzepesig`
...
```bash
sudo pacman -S --needed analyzepesig
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql analyzepesig | grep '/bin/'
```
...
```bash
# Package contents:
pacman -Ql analyzepesig | sed -n "1,80p"
```
