...
**Package name:** `dark-dork-searcher`
...
```bash
sudo pacman -S --needed dark-dork-searcher
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql dark-dork-searcher | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
dark-dork-searcher --help
dark-dork-searcher -h
man dark-dork-searcher
```
...
```bash
# Package contents:
pacman -Ql dark-dork-searcher | sed -n "1,80p"
```
