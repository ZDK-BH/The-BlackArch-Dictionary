...
**Category:** `windows`  
**Version in source list:** `1.6.0`  
**Package name:** `evil-winrm-py`

## What it does

WinRM shell for Windows and Active Directory pentesting.
...
```bash
sudo pacman -S --needed evil-winrm-py
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql evil-winrm-py | grep '/bin/'
```
...
```bash
# Package contents:
pacman -Ql evil-winrm-py | sed -n "1,80p"
```
