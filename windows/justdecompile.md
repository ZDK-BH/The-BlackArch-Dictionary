...
**Category:** `windows`  
**Version in source list:** `22018`  
**Package name:** `justdecompile`
...
```bash
sudo pacman -S --needed justdecompile
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql justdecompile | grep '/bin/'
```
...
```bash
# Package contents:
pacman -Ql justdecompile | sed -n "1,80p"
```
