...
**Category:** `windows`  
**Version in source list:** `7.4c35708`  
**Package name:** `modifycerttemplate`
...
```bash
sudo pacman -S --needed modifycerttemplate
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql modifycerttemplate | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
modifycerttemplate --help
modifycerttemplate -h
man modifycerttemplate
```
...
```bash
# Package contents:
pacman -Ql modifycerttemplate | sed -n "1,80p"
```
