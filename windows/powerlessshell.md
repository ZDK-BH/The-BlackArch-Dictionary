...
**Category:** `windows`  
**Version in source list:** `117.b168ccb`  
**Package name:** `powerlessshell`
...
```bash
sudo pacman -S --needed powerlessshell
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql powerlessshell | grep '/bin/'
```
...
```bash
# Package contents:
pacman -Ql powerlessshell | sed -n "1,80p"
```
