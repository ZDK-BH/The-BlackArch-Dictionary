...
**Category:** `windows`  
**Version in source list:** `17.e7e8d0a`  
**Package name:** `python2-minikerberos`
...
```bash
sudo pacman -S --needed python2-minikerberos
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql python2-minikerberos | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
python2-minikerberos --help
python2-minikerberos -h
man python2-minikerberos
```
...
```bash
# Package contents:
pacman -Ql python2-minikerberos | sed -n "1,80p"
```
