...
**Category:** `windows`  
**Version in source list:** `5.1.8`  
**Package name:** `resourcehacker`
...
```bash
sudo pacman -S --needed resourcehacker
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql resourcehacker | grep '/bin/'
```
...
```bash
# Package contents:
pacman -Ql resourcehacker | sed -n "1,80p"
```
