...
**Category:** `wireless`  
**Version in source list:** `2.0.5`  
**Package name:** `python-trackerjacker`
...
```bash
sudo pacman -S --needed python-trackerjacker
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql python-trackerjacker | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
python-trackerjacker --help
python-trackerjacker -h
man python-trackerjacker
```
