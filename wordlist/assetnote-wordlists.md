...
**Category:** `wordlist`  
**Version in source list:** `183.6dea231`  
**Package name:** `assetnote-wordlists`
...
```bash
sudo pacman -S --needed assetnote-wordlists
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql assetnote-wordlists | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
assetnote-wordlists --help
assetnote-wordlists -h
man assetnote-wordlists
```
