...
**Category:** `wordlist`  
**Version in source list:** `1.2.r20.g78cd116`  
**Package name:** `ldapwordlistharvester`
...
```bash
sudo pacman -S --needed ldapwordlistharvester
```

Confirm the installed files and find the actual executable name:

```bash
pacman -Ql ldapwordlistharvester | grep '/bin/'
```

Open the built-in help before running anything meaningful:

```bash
ldapwordlistharvester --help
ldapwordlistharvester -h
man ldapwordlistharvester
```
